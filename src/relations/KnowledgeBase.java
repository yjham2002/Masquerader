...
public class KnowledgeBase extends HashMap<String, HashMap<String, Integer>> {
    ...
    public KnowledgeBase(int set){
        if(actionBase == null) actionBase = new ActionBase();
    ...
    private void wakeUp(){
        ...
        switch (current_set){
            case SET_SENTENCE_RECOGNIZE :
                ...
                knowledgeFractions = commonSVC.getKnowledges();
            ...
            case SET_METAPHOR_RECOGNIZE :
                ...
                knowledgeFractions = commonSVC.getMetaphors();
            ...
            case SET_STATIC_QUESTION :
                ...
                knowledgeFractions = commonSVC.getStaticBases();
    ...
    public boolean memorize(String sWord, String sTag, String intention, String resp){
        ...
        return commonSVC.saveStaticSentence(sWord, sTag, intention, resp);
    }
    ...
    public int learn(List<TypedPair> linkPair){
        if(CURRENT_MODE == REAL_MODE) {
            ...
            switch (current_set){
                case SET_SENTENCE_RECOGNIZE : {
                    commonSVC.saveKnowledgeLink(linkPair.get(0), linkPair.get(1), reverse);
                } break;
                case SET_METAPHOR_RECOGNIZE : {
                    commonSVC.saveMetaLink(linkPair.get(0), linkPair.get(1));
                } break;
                default: break;
            }
        }
