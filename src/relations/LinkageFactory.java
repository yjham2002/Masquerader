 ...
 */
public class LinkageFactory extends BaseService{
    ...
    private void init(){
        ...
        // 지식 베이스 캐싱 시작
        this.base = new KnowledgeBase(KnowledgeBase.SET_SENTENCE_RECOGNIZE);
        this.metaBase = new KnowledgeBase(KnowledgeBase.SET_METAPHOR_RECOGNIZE);
        this.staticBase = new KnowledgeBase(KnowledgeBase.SET_STATIC_QUESTION);
        // 지식 베이스 캐싱 종료

        timeParser = new TimeParser();
        staticResponser = new StaticResponser();
