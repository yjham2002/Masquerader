...
import databases.mybatis.mapper.SqlMapper;
 ...
 */
public class StaticResponser extends BaseService{
        ...
        switch (intent){
            case INTENT_DIRECT: {
                try(SqlSession sqlSession = super.getSession()){
                    ...
                    response = commMapper.getDirectResponse(msg);
                }
            } break;
